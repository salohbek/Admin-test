                          ...
                          <ul class="metismenu" id="side-menu">
                              ...
                              <li>
                                  ...
                                  <ul class="submenu">
                                      ...
                                      <li><router-link to="/email-read">Email Read</router-link></li>
                                      <li><router-link to="/email-compose">Email Compose</router-link></li>
                                  </ul>
                              </li>
      
                              <li>
                                  <router-link to="/calendar" class="waves-effect"><i class="icon-calendar"></i><span> Calendar </span></router-link>
                              </li>
                              ...
                              <li>
                                  ...
                                  <ul class="submenu">
                                      ...
                                      <li><router-link to="/tables-datatable">Data Table</router-link></li>
...
@import url(../public/assets/css/metismenu.min.css);
@import url(../public/assets/plugins/datatables/dataTables.bootstrap4.min.css);
